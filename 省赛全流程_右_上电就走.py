...
STRAIGHT_TRANSITION_EXIT_FROM_BOTTOM_PX = 35 # 从ROI底部算起，小于此像素距离则退出直行
...
STOP_ZONE_ROI_HEIGHT_PX = 5        # 从图像底部向上计算的窗口高度
...
EXIT_MIN_LENGTH_M = 0.32               # 板子最小长度 (米)
EXIT_MAX_LENGTH_M = 0.68               # 板子最大长度 (米)
